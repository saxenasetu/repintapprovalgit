sap.ui.define([
	...
	return UIComponent.extend("vodafone.RepintApprov.repintapproval.Component", {
		...
		/*	var oEmpModel = new sap.ui.model.json.JSONModel();
            ...
            this.setModel(oEmpModel, "empModel");
			//	var empID = sap.ushell.Container.getService("UserInfo").getId();

			var xsoDataModel = new sap.ui.model.odata.v2.ODataModel("/HANAMDC/REPINT/RepintApproval/xsodata/RepintApproval.xsodata/", {
				json: true,

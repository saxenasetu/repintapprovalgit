sap.ui.define([
	"sap/ui/test/Opa5",
	"vodafone/RepintApprov/repintapproval/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("vodafone.RepintApprov.repintapproval.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "vodafone.RepintApprov.repintapproval",
					async: true
				},
				hash: oOptions.hash,
